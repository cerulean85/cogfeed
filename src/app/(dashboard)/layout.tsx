...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* 메인 콘텐츠 */}
      <main
        className="flex flex-1 flex-col justify-between px-4 pt-[calc(1.5rem+env(safe-area-inset-top))] pb-[calc(5rem+env(safe-area-inset-bottom))] md:px-8 md:pt-8 md:pb-8"
        id="main-content"
      >
